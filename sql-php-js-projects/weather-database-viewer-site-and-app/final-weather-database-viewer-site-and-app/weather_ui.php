...
session_start(); //  Add this line first to enable session tracking
...
<body>
    <p style="text-align: right; padding: 10px;">
    	Logged in as <strong><?= htmlspecialchars($_SESSION['user_name'] ?? $_SESSION['user_email'] ?? 'User') ?></strong> |
    	<a href="logout.php">Logout</a>
    </p>
    <!-- Main Title -->
    <h1>SkyView Weather Database Viewer</h1>
